"""cadogan_sinopec_finally_came_up_with_agent_name — OUT-OF-GRID KNOWLEDGE: what you can SENSE but cannot SEE.
...
from sea_of_colours.orchestrator_2.harnesses.cadogan_sinopec_finally_came_up_with_agent_name.world_view import (
    _live_rows,
    _my_probe_cells,
    _tier,
)
