...
What lives here is only what ``cadogan_sinopec_finally_came_up_with_agent_name/prompt.py`` still imports:
...
``cadogan_sinopec_finally_came_up_with_agent_name/prompt.py``; if you are looking for section order, doctrine
