> ### This directory is yours — CADOGAN_SINOPEC_FINALLY_CAME_UP_WITH_AGENT_NAME
>
...
```44:75:sea_of_colours/orchestrator_2/harnesses/cadogan_sinopec_finally_came_up_with_agent_name/orbit_policy.py
...
```43:43:sea_of_colours/orchestrator_2/harnesses/cadogan_sinopec_finally_came_up_with_agent_name/_v7/chat_schema.py
...
Prefer changing `cadogan_sinopec_finally_came_up_with_agent_name/` proper; touch `_v7/` only for shared
...
| --- | --- | --- |
| `CADOGAN_SINOPEC_FINALLY_CAME_UP_WITH_AGENT_NAME_SINGLE` | `0` | `1` skips the THINK/PLAN split — one LLM call, faster, dumber |
| `CADOGAN_SINOPEC_FINALLY_CAME_UP_WITH_AGENT_NAME_AUTOFILL` | `0` | `1` lets the packager top up a short plan |
