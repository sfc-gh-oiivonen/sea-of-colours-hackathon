...
What lives here is only what ``oiivonen_pistolpete3000/prompt.py`` still imports:
...
``oiivonen_pistolpete3000/prompt.py``; if you are looking for section order, doctrine
